...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(
        ...
        default="/map-vepfs/siwei/coig/hf/Meta-Llama-3-8B-Instruct",
        metadata={
...
model = AutoModelForSequenceClassification.from_pretrained(
    pretrained_model_name_or_path  = "/map-vepfs/huggingface/models/Llama-3.1-8B-Instruct", num_labels=1, torch_dtype=torch.bfloat16, use_flash_attention_2=True,
)#use_flash_attention_2=True .cuda()
